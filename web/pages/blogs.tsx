      ...
      <Container maxW={"7xl"} p="12">
        ...
        >
          ...
          <Text p={3}  color={"gray.500"}>
            ...
            experiences, increase awareness and understanding, and provide
            comfort and support. And that’s a very good thing.Here Are a few
            Blogs, We thought we’d pop a list together of the blogs we
            frequently read, admire and appreciate. We hope you enjoy them as we
            do.
          </Text>
        </Stack>
        {data.map((blog, index) => (
