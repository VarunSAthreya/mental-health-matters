      ...
      <Container maxW={"7xl"} p="12">
        ...
        >
          ...
          <Text p={3} color="white">
            Our mission to make quality healthcare affordable and accessible for
            over a billion+ Indians. We believe in empowering our users with the
            most accurate, comprehensive, and curated information and care,
            enabling them to make better healthcare decisions
          </Text>
        </Stack>

        <SimpleGrid columns={2} space={10} py={{ base: 20, md: 28 }}>
          <Flex>
            <Image
              rounded={"md"}
              alt={"feature image"}
          ...
          <Stack space={4}>
            ...
            <Text color={"gray.500"} fontSize={"lg"}>
              ...
              sed. Arcu vitae elementum curabitur vitae nunc sed velit
        ...
        <Box p={4}>
          ...
          <SimpleGrid columns={4} space={10} py={5}>
